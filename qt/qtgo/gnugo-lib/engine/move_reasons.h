...
int move_reason_known(board_lib_state_struct *internal_state,
                      int pos, int type, int what);
int attack_move_reason_known(board_lib_state_struct *internal_state,
                             int pos, int what);
int defense_move_reason_known(board_lib_state_struct *internal_state,
                              int pos, int what);
int owl_attack_move_reason_known(board_lib_state_struct *internal_state,
                                 int pos, int what);
int owl_defense_move_reason_known(board_lib_state_struct *internal_state,
                                  int pos, int what);
int owl_move_reason_known(board_lib_state_struct *internal_state,
                          int pos, int what);
...
void discard_redundant_move_reasons(board_lib_state_struct *internal_state,
                                    int pos);

void mark_changed_dragon(board_lib_state_struct *internal_state,
