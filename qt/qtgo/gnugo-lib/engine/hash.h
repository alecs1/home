...
Hash_data goal_to_hashvalue(struct board_lib_state_struct *internal_state, const signed char *goal);
...
char *hashdata_to_string(struct board_lib_state_struct *internal_state, Hash_data *hashdata);
