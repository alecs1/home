...
static struct autohelper_func autohelper_functions[] = {
  ...
  {"lib",			1, 0, 0.01, "countlib(internal_state, %s)"},
  {"alive",			1, 0, 0.01,
  ...
  {"ko", 			1, 0, 0.01, "is_ko_point(internal_state, %s)"},
  {"xdefend_against",		2, 0, 1.00,
        "defend_against(internal_state, %s, OTHER_COLOR(color), %s)"},
  {"odefend_against",		2, 0, 1.00, "defend_against(internal_state, %s, color, %s)"},
  {"defend_against_atari",	1, 0, 1.00,
        "defend_against_atari_helper(internal_state, move, %s)"},
  {"does_defend",		2, 0, 1.00, "does_defend(internal_state, %s, %s)"},
  {"does_attack",		2, 0, 1.00, "does_attack(internal_state, %s, %s)"},
  {"attack",			1, 0, 1.00, "ATTACK_MACRO(%s)"},
  {"defend",			1, 0, 1.00, "DEFEND_MACRO(%s)"},
  {"weakness",			1, 0, 0.01, "dragon_weakness(%s, 0)"},
  {"weak",			1, 0, 0.01, "dragon_weak(internal_state, %s)"},
  {"safe_xmove", 		1, 0, 1.00, "safe_move(internal_state, %s, OTHER_COLOR(color))"},
  {"safe_omove", 		1, 0, 1.00, "safe_move(internal_state, %s, color)"},
  {"legal_xmove",		1, 0, 0.05, "is_legal(internal_state, %s, OTHER_COLOR(color))"},
  {"legal_omove",		1, 0, 0.05, "is_legal(internal_state, %s, color)"},
  {"x_suicide",			1, 0, 0.05, "is_suicide(internal_state, %s, OTHER_COLOR(color))"},
  {"o_suicide",			1, 0, 0.05, "is_suicide(internal_state, %s, color)"},
  {"x_alive_somewhere",		0, 1, 0.01,
        "somewhere(internal_state, OTHER_COLOR(color), 1, %d"},
  {"o_alive_somewhere",		0, 1, 0.01, "somewhere(internal_state, color, 1, %d"},
  {"x_somewhere",		0, 1, 0.01,
        "somewhere(internal_state, OTHER_COLOR(color), 0, %d"},
  {"o_somewhere",		0, 1, 0.01, "somewhere(internal_state, color, 0, %d"},
  {"xmoyo_opposite",		1, 0, 0.01,
      "(whose_moyo(internal_state, INITIAL_INFLUENCE(color), %s) == OTHER_COLOR(color))"},
  {"omoyo_opposite",		1, 0, 0.01,
      "(whose_moyo(internal_state, INITIAL_INFLUENCE(color), %s) == color)"},
  {"xmoyo",			1, 0, 0.01,
      "(whose_moyo(internal_state, OPPOSITE_INFLUENCE(color), %s) == OTHER_COLOR(color))"},
  {"omoyo",			1, 0, 0.01,
      "(whose_moyo(internal_state, OPPOSITE_INFLUENCE(color), %s) == color)"},
  {"xarea",			1, 0, 0.01,
      "(whose_area(internal_state, OPPOSITE_INFLUENCE(color), %s) == OTHER_COLOR(color))"},
  {"oarea",			1, 0, 0.01, 
      "(whose_area(internal_state, OPPOSITE_INFLUENCE(color), %s) == color)"},
  {"xterri",			1, 0, 0.01,
      "(whose_territory(internal_state, OPPOSITE_INFLUENCE(color), %s) == OTHER_COLOR(color))"},
  {"oterri",			1, 0, 0.01,
      "(whose_territory(internal_state, OPPOSITE_INFLUENCE(color), %s) == color)"},
  ...
  {"xlib",			1, 0, 0.05,
    "accuratelib(internal_state, %s, OTHER_COLOR(color), MAX_LIBERTIES, NULL)"},
  {"olib",			1, 0, 0.05,
    "accuratelib(internal_state, %s, color, MAX_LIBERTIES, NULL)"},
  {"xcut",			1, 0, 0.01,
  ...
  {"xplay_defend_both",		2, 1, 3.00,
        "play_attack_defend2_n(internal_state, OTHER_COLOR(color), 0, %d"},
  {"oplay_defend_both",		2, 1, 3.00, "play_attack_defend2_n(internal_state, color, 0, %d"},
  {"xplay_attack_either",	2, 1, 3.00,
        "play_attack_defend2_n(internal_state, OTHER_COLOR(color), 1, %d"},
  {"oplay_attack_either",	2, 1, 3.00, "play_attack_defend2_n(internal_state, color, 1, %d"},
  {"xplay_defend",		1, 1, 1.00,
        "play_attack_defend_n(internal_state, OTHER_COLOR(color), 0, %d"},
  {"oplay_defend",		1, 1, 1.00, "play_attack_defend_n(internal_state, color, 0, %d"},
  {"xplay_attack",		1, 1, 1.00,
        "play_attack_defend_n(internal_state, OTHER_COLOR(color), 1, %d"},
  {"oplay_attack",		1, 1, 1.00, "play_attack_defend_n(internal_state, color, 1, %d"},
  {"xplay_break_through",	3, 1, 5.00,
        "play_break_through_n(internal_state, OTHER_COLOR(color), %d"},
  {"oplay_break_through",	3, 1, 5.00, "play_break_through_n(internal_state, color, %d"},
  {"oplay_connect",		2, 1, 10.00, "play_connect_n(internal_state, color, 1, %d"},
  {"xplay_connect",		2, 1, 10.00,
        "play_connect_n(internal_state, OTHER_COLOR(color), 1, %d"},
  {"oplay_disconnect",		2, 1, 10.00, "play_connect_n(internal_state, color, 0, %d"},
  {"xplay_disconnect",		2, 1, 10.00,
        "play_connect_n(internal_state, OTHER_COLOR(color), 0, %d"},
  {"oplay_lib",	        	1, 1, 0.06, "play_lib_n(color, %d"},
  {"xplay_lib",  		1, 1, 0.06,
                "play_lib_n(OTHER_COLOR(color), %d"},
  {"seki_helper",		1, 0, 0.0, "seki_helper(internal_state, %s)"},
  {"threaten_to_save",		1, 0, 0.0, "threaten_to_save_helper(internal_state, move,%s)"},
  {"threaten_to_capture",	1, 0, 0.0,
    		"threaten_to_capture_helper(move,%s)"},
  {"prevent_attack_threat",	1, 0, 0.0,
        "prevent_attack_threat_helper(internal_state, move, %s)"},
  ...
  {"owl_topological_eye",	2, 0, 0.01, "owl_topological_eye(%s, internal_state->board[%s])"},
  {"obvious_false_oeye",	1, 0, 0.01, "obvious_false_eye(internal_state, %s, color)"},
  {"obvious_false_xeye",	1, 0, 0.01,
        "obvious_false_eye(internal_state, %s, OTHER_COLOR(color))"},
  {"antisuji",			1, 0, 0.0, "add_antisuji_move(internal_state, %s)"},
  {"add_connect_move",		2, 0, 0.0, "add_connection_move(internal_state, move,%s, %s)"},
  {"add_cut_move",		2, 0, 0.0, "add_cut_move(internal_state, move, %s, %s)"},
  {"test_attack_either_move",	2, 0, 0.0,
        "test_attack_either_move(internal_state, move, color, %s, %s)"},
  {"add_defend_both_move",	2, 0, 0.0,
        "add_all_move(internal_state, move, DEFEND_STRING, %s, DEFEND_STRING, %s)"},
  {"same_dragon",		2, 0, 0.01, "is_same_dragon(internal_state, %s, %s)"},
  {"same_string",		2, 0, 0.01, "same_string(internal_state, %s, %s)"},
  {"dragonsize", 		1, 0, 0.01, "dragon[%s].size"},
  {"wormsize",			1, 0, 0.01, "countstones(internal_state, %s)"},
  {"effective_size",		1, 0, 0.01, "dragon[%s].effective_size"},
  {"vital_chain",		1, 0, 0.05, "vital_chain(internal_state, %s)"},
  {"potential_cutstone",	1, 0, 0.01, "worm[%s].cutstone2 > 1"},
  {"amalgamate_most_valuable_helper", 3, 0, 0.0,
        "amalgamate_most_valuable_helper(internal_state, %s, %s, %s)"},
  {"amalgamate", 		2, 0, 0.0, "join_dragons(internal_state, %s, %s)"},
  {"owl_escape_value",		1, 0, 0.01, "owl_escape_value(internal_state, %s)"},
  {"owl_goal_dragon",		1, 0, 0.01, "owl_goal_dragon(%s)"},
  {"owl_eyespace",		1, 0, 0.01, "owl_eyespace(internal_state, %s)"},
  {"owl_big_eyespace",		1, 0, 0.01, "owl_big_eyespace(internal_state, %s)"},
  {"owl_mineye",		1, 0, 0.01, "owl_mineye(internal_state, %s)"},
  {"owl_maxeye",		1, 0, 0.01, "owl_maxeye(internal_state, %s)"},
  {"owl_proper_eye",		1, 0, 0.01, "owl_proper_eye(internal_state, %s)"},
  {"owl_eye_size",		1, 0, 0.01, "owl_eye_size(internal_state, %s)"},
  {"owl_lunch",                 1, 0, 0.01, "owl_lunch(internal_state, %s)"},
  {"owl_strong_dragon",		1, 0, 0.01, "owl_strong_dragon(internal_state, %s)"},
  {"has_aji",			1, 0, 0.01,
		"(dragon[%s].owl_threat_status == CAN_THREATEN_DEFENSE)"},
  {"finish_ko_helper",		1, 0, 0.05, "finish_ko_helper(internal_state, %s)"},
  {"squeeze_ko_helper",		1, 0, 0.03, "squeeze_ko_helper(internal_state, %s)"},
  {"backfill_helper",		3, 0, 1.50, "backfill_helper(internal_state, %s, %s, %s)"},
  {"connect_and_cut_helper2",	3, 0, 3.00,
        "connect_and_cut_helper2(internal_state, %s, %s, %s, color)"},
  {"connect_and_cut_helper",	3, 0, 3.00, "connect_and_cut_helper(internal_state, %s, %s, %s)"},
  {"owl_threatens",		2, 0, 0.01, "owl_threatens_attack(%s, %s)"},
  {"replace",			2, 0, 0.0,  "add_replacement_move(internal_state, %s, %s, color)"},
  {"backfill_replace",		2, 0, 0.0,  "backfill_replace(internal_state, %s, %s)"},
  {"non_oterritory",		1, 0, 0.0,
        "influence_mark_non_territory(internal_state, %s, color)"},
  {"non_xterritory",		1, 0, 0.0,
        "influence_mark_non_territory(internal_state, %s, OTHER_COLOR(color))"},
  {"remaining_handicap_stones",	0, 0, 0.0,  "free_handicap_remaining_stones(internal_state)"},
  {"total_handicap_stones",	0, 0, 0.0,  "free_handicap_total_stones(internal_state)"},
  {"o_captures_something", 	1, 0, 0.02, "does_capture_something(internal_state, %s, color)"},
  {"x_captures_something", 	1, 0, 0.02,
        "does_capture_something(internal_state, %s, OTHER_COLOR(color))"},
  {"false_eye_territory",	1, 0, 0.0, "false_eye_territory[%s]"},
  {"false_eye",			1, 0, 0.01, "is_false_eye(half_eye, %s)"},
  {"o_visible_along_edge",	2, 0, 0.05, "visible_along_edge(internal_state, color,%s,%s)"},
  {"x_visible_along_edge",	2, 0, 0.05, 
                "visible_along_edge(internal_state, OTHER_COLOR(color),%s,%s)"},
  ...
  {"adjacent_to_stone_in_atari", 1, 0, 1.0,
                "adjacent_to_stone_in_atari(internal_state, %s)"},
  {"adjacent_to_defendable_stone_in_atari", 1, 0, 1.0,
                "adjacent_to_defendable_stone_in_atari(internal_state, %s)"},
  {"good_attack_threat",	2, 0, 0.01, "register_good_attack_threat(internal_state, %s, %s)"},
  {"known_safe_move",		1, 0, 0.01, "register_known_safe_move(internal_state, %s)"},
  {"break_mirror_helper",	1, 0, 0.01, "break_mirror_helper(internal_state, %s, color)"}
};


/* To get a valid function pointer different from NULL. */
static int
dummyhelper(board_lib_state_struct* internal_state, int transformation, int move, int color, int action)
{
...
finish_constraint_and_action(void)
{
  ...
  code_pos += sprintf(code_pos, 
              "static int\nautohelper%s%d(board_lib_state_struct* internal_state, int trans, int move, int color, int action)\n{\n  int",
		      prefix, patno);
