...
if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = "https://slogin.ft.com";
...
if (typeof janrain.settings.width === 'undefined')janrain.settings.width = "160";
if (typeof janrain.settings.providersPerPage === 'undefined')janrain.settings.providersPerPage = "1";
...
if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = "abdmmlbjpegmnihfjcem";
if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = "https://slogin.ft.com";
janrain.settings.permissions = ["customizable_auth_widget_hide_attribution","customizable_auth_widget_styling"];
if (typeof janrain.settings.providers === 'undefined')janrain.settings.providers = ["twitter"];
...
if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = "https://slogin.ft.com";
...
function getPackagePath(packages) {
    ...
    var path = rootPath + 'manifest/' + packages.join(':') + '?version=' + encodeURIComponent('2014.WID.1.101.1_widgets_422');
    return path;
}
